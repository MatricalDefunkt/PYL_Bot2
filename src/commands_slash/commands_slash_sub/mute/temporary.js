                ...
                .then( () =>
                {
                    ...
                    bannee
                        ...
                        .then( async () =>
                        {
                            ...
                            const dbmod = `<@${ infraction.tempMute.getDataValue( 'modID' ) }>`;
                            const dbreason = infraction.tempMute.getDataValue( 'reason' );
                            const dbtime = `<t:${ Math.trunc( Date.parse( infraction.tempMute.getDataValue( 'createdAt' ) ) / 1000 ) }:F>`;
                            const dbduration = infraction.tempMute.getDataValue( 'duration' )
